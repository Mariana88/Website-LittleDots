...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
	  	$this->options = array(
            ...
            'upload_dir' => $_SERVER['DOCUMENT_ROOT'] . ((isset($_SESSION["newBrowse"]["last_selected_folder"]))?$_SESSION["newBrowse"]["last_selected_folder"] . '/':'/userfiles/public/'),
            'upload_url' => $_SERVER['HTTP_HOST'] . ((isset($_SESSION["newBrowse"]["last_selected_folder"]))?$_SESSION["newBrowse"]["last_selected_folder"] . '/':'/userfiles/public/'),
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
